function AddFileInputt() {
    ...
    table.innerHTML += '<label><input onchange="changeLabelText(this)" style="position: absolute; clip: rect(0,0,0,0)" name="FILE_' + counter + '" size="30" type="file"><span class="button nomb f14">Прикрепить файл</span><span class="filename">Файл не выбран</span></label><br /><span id="files_table_' + counter + '"></span>';
}
...
$(function () {
    ...
    $(".has-next-hidden").click(function(){
        $(this).next().show();
        $(this).removeClass("has-next-hidden");
    });
});