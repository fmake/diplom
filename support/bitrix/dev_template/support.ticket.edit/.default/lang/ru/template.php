...
$MESS ['SUP_KB'] = "Кб";
$MESS ['SUP_MORE'] = "Еще...";
$MESS ['SUP_CLOSE_TICKET'] = "Закрыть обращение (включите, если задача выполнена)";
$MESS ['SUP_OPEN_TICKET'] = "Открыть обращение (включите, если нужно доделать)";
$MESS ['SUP_SAVE'] = "Сохранить";
$MESS ['SUP_APPLY'] = "Написать";
