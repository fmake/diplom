...
; /* Start:/bitrix/templates/future-group_new/components/bitrix/support.ticket/dev_template/bitrix/support.ticket.edit/.default/script.js*/
function AddFileInputt() {
    ...
    table.innerHTML += '<label><input onchange="changeLabelText(this)" style="position: absolute; clip: rect(0,0,0,0)" name="FILE_' + counter + '" size="30" type="file"><span class="button nomb">Прикрепить</span><span class="filename">Файл не выбран</span></label><br /><span id="files_table_' + counter + '"></span>';
}
...
$(function () {
    ...
    changeLabelText = function(obj){
        var file_api = ( window.File && window.FileReader && window.FileList && window.Blob ) ? true : false;
        var inp = $(obj);
        var lbl = inp.next().next();
...
/* End */
;
; /* Start:/bitrix/templates/future-group_new/components/bitrix/support.ticket/dev_template/bitrix/support.ticket.edit/.default/ru/script.js*/
...
/* End */
;; /* /bitrix/templates/future-group_new/components/bitrix/support.ticket/dev_template/bitrix/support.ticket.edit/.default/script.js*/
; /* /bitrix/templates/future-group_new/components/bitrix/support.ticket/dev_template/bitrix/support.ticket.edit/.default/ru/script.js*/
